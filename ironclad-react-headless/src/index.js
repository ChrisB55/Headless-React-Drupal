                        ...
                        return (
                            <div className="row" key={index}>
                                <ul>
                                    ...
                                    <li><button onClick={e => deleteNode(node.nid)}> Delete</button></li>
                                </ul>
                            </div>
                        )
                    })}
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <label>Title</label>
                <br />
                <input placeholder="Node Title" type="text" onChange={e => handleChange(e, 'title')}></input>
                <br />
                <label>Body</label>
                <br />
                <textarea placeholder="Node Content" onChange={e => handleChange(e, 'body')}></textarea>
                <br />
